class DevicesController < ApplicationController
  ...
  def index
    ...
    @devices = @devices.joins(:device_model, site: :institution).within(@navigation_context.entity, @navigation_context.exclude_subsites)
    ...
    @devices = @devices.order(params['order_by'] || 'devices.name').limit(@page_size).offset(offset)
