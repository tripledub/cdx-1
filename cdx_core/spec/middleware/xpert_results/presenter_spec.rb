    ...
    it 'should return elements formated' do
      expect(CSV.parse(described_class.csv_query(XpertResult.all))[1]).to eq(
        [
          ...
          Extras::Dates::Format.datetime_with_time_zone(XpertResult.first.sample_collected_at, :full_time_with_timezone),
          Extras::Dates::Format.datetime_with_time_zone(XpertResult.first.result_at, :full_time_with_timezone),
