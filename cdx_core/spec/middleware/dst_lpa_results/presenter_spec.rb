  ...
  describe 'index_table' do
    ...
    it 'should return elements formated' do
      expect(described_class.index_table(DstLpaResult.all).first).to eq({
        ...
        sampleCollectedOn: Extras::Dates::Format.datetime_with_time_zone(DstLpaResult.first.sample_collected_at),
        examinedBy:        DstLpaResult.first.examined_by,
        resultOn:          Extras::Dates::Format.datetime_with_time_zone(DstLpaResult.first.result_at),
