      ...
      it 'should return elements formated' do
        expect(CSV.parse(described_class.csv_query(DstLpaResult.all))[1]).to eq(
          [
            ...
            Extras::Dates::Format.datetime_with_time_zone(DstLpaResult.first.sample_collected_at, :full_time_with_timezone),
            DstLpaResult.first.examined_by,
            Extras::Dates::Format.datetime_with_time_zone(DstLpaResult.first.result_at, :full_time_with_timezone),
