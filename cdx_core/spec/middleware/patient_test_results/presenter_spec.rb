...
describe PatientTestResults::Presenter do
  ...
  describe 'patient_view' do
    ...
    it 'should return an array of formated comments' do
      expect(described_class.patient_view(PatientResult.all.page, '')['rows'].size).to eq(11)
    end

    it 'should return device test result elements formated' do
      test_result = PatientResult.first
      expect(described_class.patient_view(PatientResult.all.page, '')['rows'].first).to eq({
        id:              test_result.uuid,
    ...
    it 'should return xpert test result elements formated' do
      ...
      expect(described_class.patient_view(PatientResult.all.page, '')['rows'][10]).to eq({
    ...
    it 'should return microscopy test result elements formated' do
      ...
      expect(described_class.patient_view(PatientResult.all.page, '')['rows'][5]).to eq({
    ...
    it 'should return culture test result elements formated' do
      ...
      expect(described_class.patient_view(PatientResult.all.page, '')['rows'][7]).to eq({
    ...
    it 'should return dst/lpa test result elements formated' do
      ...
      expect(described_class.patient_view(PatientResult.all.page, '')['rows'][9]).to eq({
