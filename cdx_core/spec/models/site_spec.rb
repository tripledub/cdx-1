...
describe Site do
  ...
  it "can't destroy a site with associated devices" do
    ...
    expect { site1.destroy }.to raise_error(ActiveRecord::DeleteRestrictionError)
  end
  ...
  it 'destroys sites logically' do
    ...
    expect { site1.destroy }.to change(Site, :count).by(-1)
  ...
  describe 'roles' do
    it 'creates predefined roles for site' do
      ...
      site = nil
      expect { site = Site.make institution_id: institution.id }.to change(Role, :count).by(4)
    ...
    it 'deletes all roles when destroyed' do
      ...
      institution = Institution.make user_id: user.id
      site = Site.make institution_id: institution.id
      expect { site.destroy }.to change(Role, :count).by(-4)
    end
  end
  ...
  describe 'generate next sample entity id' do
    ...
    it 'should return a valid id to be used as sample identifier' do
      ...
      end.to change(SampleIdentifier, :count).by(1)
    end
