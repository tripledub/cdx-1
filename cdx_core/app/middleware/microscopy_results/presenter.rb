    ...
    class << self
      ...
      def add_csv_row(csv, microscopy_result)
        csv << [
          ...
          Extras::Dates::Format.datetime_with_time_zone(microscopy_result.sample_collected_at, :full_time_with_timezone),
          Extras::Dates::Format.datetime_with_time_zone(microscopy_result.result_at, :full_time_with_timezone),
