        ...
        xpert_results.map do |xpert_result|
          {
            ...
            sampleCollectedOn: Extras::Dates::Format.datetime_with_time_zone(xpert_result.sample_collected_at),
            examinedBy:        xpert_result.examined_by,
            resultOn:          Extras::Dates::Format.datetime_with_time_zone(xpert_result.result_at),
