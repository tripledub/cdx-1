      ...
      def format_test_result(test_result)
        {
          ...
          status:          I18n.t("patient_test_results.status.#{test_result.core_fields[TestResult::STATUS_FIELD]}"),
      ...
      def format_xpert_result(xpert_result)
        {
          ...
          status:          I18n.t("patient_test_results.status.#{xpert_result.result_status}"),
      ...
      def format_microscopy_result(microscopy_result)
        {
          ...
          status:          I18n.t("patient_test_results.status.#{microscopy_result.result_status}"),
      ...
      def format_culture_result(culture_result)
        {
          ...
          status:          I18n.t("patient_test_results.status.#{culture_result.result_status}"),
      ...
      def format_dst_lpa_result(dst_lpa_result)
        {
          ...
          status:          I18n.t("patient_test_results.status.#{dst_lpa_result.result_status}"),
