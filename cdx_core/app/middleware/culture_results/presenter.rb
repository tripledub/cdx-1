        ...
        culture_results.map do |culture_result|
          {
            ...
            sampleCollectedOn: Extras::Dates::Format.datetime_with_time_zone(culture_result.sample_collected_at),
            examinedBy:        culture_result.examined_by,
            resultOn:          Extras::Dates::Format.datetime_with_time_zone(culture_result.result_at),
