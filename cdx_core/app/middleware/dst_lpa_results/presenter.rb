        ...
        dst_lpa_results.map do |dst_lpa_result|
          {
            ...
            resultCm:          Extras::Select.find(DstLpaResult.dst_lpa_options, dst_lpa_result.results_cm),
            resultFq:          Extras::Select.find(DstLpaResult.dst_lpa_options, dst_lpa_result.results_fq),
            resultStatus:      Extras::Select.find(DstLpaResult.status_options, dst_lpa_result.result_status),
            feedbackMessage:   FeedbackMessages::Finder.find_text_from_patient_result(dst_lpa_result),
            comment:           dst_lpa_result.comment
          }
        end
      end
    end
