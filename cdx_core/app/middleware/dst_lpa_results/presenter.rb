        ...
        dst_lpa_results.map do |dst_lpa_result|
          {
            ...
            sampleCollectedOn: Extras::Dates::Format.datetime_with_time_zone(dst_lpa_result.sample_collected_at),
            examinedBy:        dst_lpa_result.examined_by,
            resultOn:          Extras::Dates::Format.datetime_with_time_zone(dst_lpa_result.result_at),
