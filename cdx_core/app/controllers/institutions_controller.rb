  ...
  def create
    ...
    respond_to do |format|
      if @institution.save
        ...
        format.html { redirect_to root_path, notice: I18n.t('institutions_controller.institution_created') }
  ...
  def update
    ...
    respond_to do |format|
      if @institution.update(institution_params)
        format.html { redirect_to root_path, notice: I18n.t('institutions_controller.institution_updated') }
