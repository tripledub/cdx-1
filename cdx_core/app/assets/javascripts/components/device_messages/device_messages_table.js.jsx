var DeviceMessageRow = React.createClass({
  render: function() {
    ...
    <tr>
      ...
      <td><DeviceMessageLink testOrderLink={ this.props.deviceMessage.testOrderLink } /></td>
      <td>
      ...
      <table className="table" cellPadding="0" cellSpacing="0" data-resizable-columns-id="devices-table">
        <thead>
          <tr>
            ...
            <th data-resizable-column-id="testOrderLink">{ I18n.t("components.device_messages_table.is_linked") }</th>
