module NotificationObserver
  ...
  included do
    ...
    after_save :_fire_check_notification_job, if: :_has_observable_fields?
    ...
    def _fire_check_notification_job
      selected_changed_attributes = changes.select { |k, _v| self.class._notification_observed_fields.include?(k.to_sym) }
      changed? && !selected_changed_attributes.empty? &&
