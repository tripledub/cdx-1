...
class XpertResult < PatientResult
  ...
  validates_inclusion_of :result_status, in: %w(new sample_collected sample_received pending_approval rejected completed), allow_nil: true
  ...
  class << self
    def tuberculosis_options
      [
        ...
        ['invalid', I18n.t('select.xpert.tuberculosis.invalid')]
      ]
    end
