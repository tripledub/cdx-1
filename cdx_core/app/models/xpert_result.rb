...
class XpertResult < PatientResult
  ...
  validates_inclusion_of :tuberculosis, in: %w(detected not_detected indeterminate no_result error), allow_nil: true
  ...
  class << self
    def tuberculosis_options
      [
        ...
        ['error', I18n.t('select.xpert.tuberculosis.error')]
      ]
    end
